...
export const Glyphs = {
  ...
  get instabilityThreshold() {
    return 1000 + getAdjustedGlyphEffect("effarigglyph") + ImaginaryUpgrade(7).effectOrDefault(0) + EterigaryUpgrade(7).effectOrDefault(0) +
  ...
  get extremeInstabilityThreshold() {
    return 75000 + Ra.unlocks.instabilityDelay.effectOrDefault(0) + EterigaryUpgrade(7).effectOrDefault(0);
  },
  get immenseInstabilityThreshold() {
    return 200000 + EterigaryUpgrade(7).effectOrDefault(0);
  },
