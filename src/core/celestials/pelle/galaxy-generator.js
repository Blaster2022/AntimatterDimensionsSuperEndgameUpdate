...
export const GalaxyGenerator = {
  ...
  get gainPerSecondPreCap() {
    ...
    ).times(extraGain).powEffectsOf(GalaxyGeneratorUpgrades.remnantPow, GalaxyGeneratorUpgrades.exponential);
    if (galaxyGen.gt(10)) {
  ...
  harshGalGenInstabilityByGalaxies(currGalaxies) {
    ...
    return Math.pow(Math.pow(1 + power, Decimal.log10(Decimal.clamp(currGalaxies.div(this.harshInstabilityStart), 1, 1e50)).toNumber()), Effects.product(Ra.unlocks.galGenInstabilityReduction));
  },
