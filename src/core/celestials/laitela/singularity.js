...
export const Singularity = {
  ...
  get singularitiesGained() {
    ...
    return Decimal.floor(Decimal.pow(this.gainPerCapIncrease, player.celestials.laitela.singularityCapIncreases).times(
      SingularityMilestone.singularityMult.effectOrDefault(new Decimal(1)).times(entropicCondensing)).timesEffectsOf(Ra.unlocks.singularityBoost, Ra.unlocks.singularityExtraBoost).times(EterigaryUpgrade(10).effectOrDefault(1)).powEffectsOf(Ra.unlocks.singularityPower));
  },
