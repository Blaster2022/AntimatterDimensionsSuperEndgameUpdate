...
function giveRealityRewards(realityProps) {
  ...
  if (Teresa.isRunning) {
    ...
    if (Currency.antimatter.gt(player.celestials.teresa.bestRunAM)) {
      ...
      else if (Currency.eterigaryMachines.value.eq(0)) machineRecord = DC.E10000.times(Currency.imaginaryMachines.value);
      else machineRecord = DC.E20000.times(Currency.eterigaryMachines.value);
