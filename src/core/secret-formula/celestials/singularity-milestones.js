...
export const singularityMilestones = {
  ...
  singularityPower: {
    ...
    effect: () => Currency.celestialPoints.value.max(10).log10().log10().pow(2).div(20).add(1).toNumber(),
    effectFormat: x => formatPow(x, 2, 3),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  celPointBoost: {
    ...
    effect: () => Currency.singularities.value.max(1).log10().div(1e5).pow(0.5).toNumber(),
    effectFormat: x => formatPow(x, 2, 3),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_MAIN,
  },
  ...
  iMBoost: {
    ...
    effect: () => Currency.singularities.value.max(1).log10().div(1e5).pow(0.2).toNumber(),
    effectFormat: x => formatPow(x, 2, 3),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_MAIN,
  },
  uncapDark: {
