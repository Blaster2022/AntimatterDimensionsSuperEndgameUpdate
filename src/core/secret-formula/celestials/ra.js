export const ra = {
  pets: {
    ...
    ra: {
      ...
      rawMemoryChunksPerSecond: () => 0.0004 * Decimal.pow(DimBoost.totalBoosts.add(1).pLog10().div(10), 2.5).toNumber(),
    ...
    laitela: {
      ...
      rawMemoryChunksPerSecond: () => 0.0004 * Decimal.pow(player.celestials.laitela.darkMatter.add(1).pLog10().div(10000), 0.5).toNumber(),
    ...
    pelle: {
      ...
      rawMemoryChunksPerSecond: () => 0.0004 * Decimal.pow(player.endgame.celestialPoints.add(1).pLog10().div(200), 2).toNumber(),
  ...
  unlocks: {
    ...
    alteredDimensionBoosts: {
      id: 60,
      reward: "Unlock Altered Dimension Boosts",
      pet: "ra",
      level: 10,
    ...
    chargedDimensionBoosts: {
      ...
      pet: "ra",
      level: 15,
      displayIcon: `<span class="fas fa-bolt-lightning"></span>`,
      disabledByPelle: false,
    },
    eterigaryMachineBoost: {
      id: 62,
      reward: "Eterigary Machines are boosted based on Endgame Points",
      pet: "ra",
      level: 25,
      displayIcon: `<span class="fas fa-arrows-to-circle"></span>`,
      disabledByPelle: false,
    },
    singularityPower: {
      id: 63,
      reward: "Singularity gain is squared",
      effect: 2,
      pet: "laitela",
      level: 1,
    ...
    galGenInstabilityReduction: {
      id: 70,
      reward: "Square-root the second Galaxy Generator Instability Magnitude",
      effect: 0.5,
      pet: "pelle",
      level: 1,
      displayIcon: `<span class="fab fa-phoenix-squadron"></span>`,
      disabledByPelle: false,
    },
    celPointBuff: {
      id: 71,
      reward: "Gain more Celestial Points based on Pelle Level",
      effect: () => 1 + (Ra.pets.pelle.level / 100),
      pet: "pelle",
      level: 2,
      displayIcon: `<span class="fas fa-biohazard"></span>`,
      disabledByPelle: false,
    },
    pelleXP: {
      id: 72,
      reward: "All Memory Chunks produce more Memories based on Celestial Matter",
      effect: () => Math.pow(player.endgame.celestialMatter.add(1).log10().toNumber(), 0.1),
      pet: "pelle",
      level: 5,
      displayIcon: `<span class="fab fa-centos"></span>`,
      disabledByPelle: false,
    },
    galGenUpgrades: {
      id: 73,
      reward: () => `Unlock a new Galaxy Generator Upgrade every ${formatInt(6)} levels`,
      pet: "pelle",
      level: 6,
      displayIcon: `<span class="fas fa-scale-unbalanced"></span>`,
      disabledByPelle: false,
    },
    celestialDimensionOverbuff: {
      id: 74,
      reward: "Celestial Dimensions are squared while Doomed",
      effect: 2,
      pet: "pelle",
      level: 10,
      displayIcon: `<span class="fab fa-codepen"></span>`,
      disabledByPelle: false,
    },
    celDimConversionBuff: {
      id: 75,
      reward: "The Celestial Dimension coversion rate is increased based on Celestial Points",
      effect: () => Math.pow(player.endgame.celestialPoints.add(1).log10().div(100).toNumber(), 0.5),
      pet: "pelle",
      level: 15,
      displayIcon: `<span class="fas fa-angles-up"></span>`,
      disabledByPelle: false,
    },
